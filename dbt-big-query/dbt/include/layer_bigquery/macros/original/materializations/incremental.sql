...
{% macro dbt_layer_bigquery_validate_get_incremental_strategy(config) %}
...
{% materialization incremental, adapter='layer_bigquery' -%}
  ...
  {% set strategy = dbt_layer_bigquery_validate_get_incremental_strategy(config) -%}
